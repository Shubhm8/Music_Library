...
if (!storedUser) { 
    ...
    var PLAYLIST_API = "http://192.168.1.52:8080/api/playlists";
    var SONGS_API = "http://192.168.1.52:8082/api/songs/available"; 
    ...
    function playSongAtIndex(index) {
        ...
        if (song.audioPath && song.audioPath.trim() !== "") {
            ...
            if (!streamUrl.startsWith("http")) {
            	streamUrl = "http://192.168.1.52:8082" +
                (streamUrl.startsWith("/") ? streamUrl : "/" + streamUrl);
            }
