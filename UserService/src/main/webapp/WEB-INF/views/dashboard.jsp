...
const NOTIF_API = "http://192.168.1.52:8085/notify/recent";
...
const CLEAR_NOTIF_API = "http://192.168.1.52:8085/notify/all";
...
async function clearAllNotifications() {
    ...
    try {
        ...
        const response = await fetch(CLEAR_NOTIF_API, {
            method: "DELETE"
        });
        ...
        if (response.ok) {
            ...
            localStorage.removeItem("lastSeenNotifId");
            localStorage.removeItem("clearedNotifId");
