...
<script>
const USER_SERVICE_URL = "http://192.168.1.52:8080/api/users";
        ...
        users.forEach(u => {
            ...
            html += `
                <tr>
                    ...
                    <td>
                        <button
                            onclick="updateStatus(${u.userId}, '${u.status}')"
...
async function deleteUser(id) {
    ...
    await fetch(USER_SERVICE_URL + "/" + id, {
        method: "DELETE"
    });
