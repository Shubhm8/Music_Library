...
<div class="container">
    ...
    <a href="${pageContext.request.contextPath}/admin/songs"
       class="filter-btn ${empty type && empty status ? 'active' : ''}">
        All
    </a>

    <a href="${pageContext.request.contextPath}/admin/songs?status=AVAILABLE"
       class="filter-btn ${status=='AVAILABLE' ? 'active' : ''}">
        Available
    </a>

    <a href="${pageContext.request.contextPath}/admin/songs?type=FREE"
       class="filter-btn ${type=='FREE' ? 'active' : ''}">
        Free
    </a>

    <a href="${pageContext.request.contextPath}/admin/songs?type=PREMIUM"
       class="filter-btn ${type=='PREMIUM' ? 'active' : ''}">
        Premium
    </a>
        ...
        <div class="search-box">
           <form action="${pageContext.request.contextPath}/admin/songs" method="get" class="search-form">
    ...
    <img
        class="song-cover"
        src="${pageContext.request.contextPath}${song.imagePath}"
        alt="${song.songName}">
                ...
                <div class="card-footer">
                   ...
                   <a href="#"
   class="delete-btn"
   onclick="openDeleteModal(${song.libraryId}, '${song.songName}')">
    🗑 Delete
</a>
                </div>
            </div>
...
<div class="pagination">
    ...
    <c:if test="${currentPage > 0}">
        <a href="?page=${currentPage-1}&search=${search}&type=${type}&status=${status}">
            ← Previous
        </a>
    </c:if>

    <c:forEach begin="0" end="${totalPages-1}" var="i">
        <a href="?page=${i}&search=${search}&type=${type}&status=${status}"
...
<script>
    ...
    function openDeleteModal(id, name) {
        ...
        document.getElementById("confirmDelete").onclick = function() {
            window.location.href = "/admin/songs/delete?id=" + id;
        };
    }
