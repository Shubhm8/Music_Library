...
public interface SongsLibraryRepository extends JpaRepository<SongsLibrary, Integer> {
	Page<SongsLibrary> findAll(Pageable pageable);
	Page<SongsLibrary> findBySongNameContainingIgnoreCaseOrSingerContainingIgnoreCaseOrAlbumNameContainingIgnoreCaseOrMusicDirectorContainingIgnoreCase(
	        String songName,
	        String singer,
	        String album,
	        String director,
	...
	Page<SongsLibrary> findBySongType(
	        String songType,
	        Pageable pageable);

	Page<SongsLibrary> findBySongStatus(
	        String songStatus,
	        Pageable pageable);

	Page<SongsLibrary> findBySongStatusAndSongType(
	        String songStatus,
	        String songType,
	        Pageable pageable);
